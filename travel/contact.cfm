...
<body>
	<div id="page">
		...
		<div id="header">
			<div id="site_title">
				<a href="index.html">A <span id="NewYork">New Yorker's</span> Guide to <span id="traveling"> Traveling the World</span>
			</div>
			<div id="login">
				  	...
				  	<li><a href="tips.html">Tips for Travelers</a>
				  		<ul class="header_submenu">
				  			<li><a href="France.html">France</a>
				  				<ul>
				  					<li><a href="paris.html">Prais</a></li>
